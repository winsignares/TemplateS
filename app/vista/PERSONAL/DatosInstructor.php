<main id="main" class="main">
  <br>
     ...
     <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
               <h1 class="card-title" style="font-size:30px;">INSTRUCTOR &nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" type="submit" style="height: 50px;" data-bs-toggle="modal" data-bs-target="#ModalRegistroInstructor">AGREGAR</button></h1>
             </div>
           </div>
         </div>
      </div>
  ...
  <section class="section">
    ...
    <form action="" method="POST" id="RegistrarInstructor">
      <div class="modal fade" id="ModalRegistroInstructor" tabindex="-1">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><b>REGISTRAR INSTRUCTOR</b></h5>
