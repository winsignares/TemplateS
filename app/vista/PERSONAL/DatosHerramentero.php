<main id="main" class="main">
  <br>
     ...
     <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
               <h1 class="card-title" style="font-size:30px;">HERRAMENTERO &nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" type="submit" style="height: 50px;" data-bs-toggle="modal" data-bs-target="#ModalRegistroHerramentero">AGREGAR</button></h1>
             </div>
           </div>
         </div>
      </div>
  ...
  <section class="section">
    ...
    <form action="" method="POST" id="RegistrarHerramentero">
      <div class="modal fade" id="ModalRegistroHerramentero" tabindex="-1">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><b>REGISTRAR HERRAMENTERO</b></h5>
    ...
    <form action="" method="POST" id="EditarHerramentero">
      <div class="modal fade" id="ModalEditHerramentero" tabindex="-1">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><b>EDITAR HERRAMENTERO</b></h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
             <div class="container">
